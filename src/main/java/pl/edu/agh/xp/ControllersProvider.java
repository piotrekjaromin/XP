...
public class ControllersProvider {
    ...
    public Controller createCompanyController(MenuController menuController) {
        CompaniesController companiesController = new CompaniesController(new CompaniesRepositoryImpl(), new CompaniesView());
    ...
    public Controller createProjectController(Integer companyId, MenuController menuController) {
        ProjectController projectController = new ProjectController(new ProjectRepositoryImpl(), new ProjectView());
